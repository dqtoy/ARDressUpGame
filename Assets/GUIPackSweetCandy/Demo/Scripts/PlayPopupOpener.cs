...
public class PlayPopupOpener : PopupOpener
{
	...
	private GameObject popupPlayButton;
    ...
    public override void OpenPopup()
    {
		...
		popupPlayButton = popup.transform.Find ("PlayButton").gameObject;
		if (popupPlayButton != null) {
			popupPlayButton.GetComponent<SceneTransition> ().scene = LevelSceneName;
		}
